...
export const STORY_TIMELINE = [
  ...
  // ==========================================
  {
    ...
    title: 'THE LOTUS ISLAND',
    caption: 'Enchanted waters hide dangerous temptation and sweet oblivion.',
  },
  {
    videoIndex: 3,
    start: 2.5,
    ...
    caption: 'Deep within the stone cavern, a ruthless eye watches in the dark.',
  },
  {
    videoIndex: 3,
    start: 5.0,
    end: 7.5,
    title: "THE SIRENS' STRAIT",
    caption: 'Treacherous melodies echo across the black rocks to lure crews astray.',
  },
  {
    videoIndex: 3,
    start: 7.5,
    end: 10.0,
    title: "CIRCE'S ENCHANTED DOMAIN",
    caption: 'Ancient sorcery and hidden archives guard the final passage to Ithaca.',
  },
