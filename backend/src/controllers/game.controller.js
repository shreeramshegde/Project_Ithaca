...
const submitAnswer = async (req, res) => {
  ...
  try {
    ...
    const isMatch = (input, expected) => {
      ...
      if (normExp === '73' && normIn === '73') return true;
      if (normExp === 'abs' && (normIn === 'abs' || normIn === 'antilockbrakingsystem')) return true;
      if (normExp === '10' && (normIn === '10' || normIn === 'ten')) return true;
      if (normExp === '24' && normIn === '24') return true;
      if (normExp === '1' && (normIn === '1' || normIn === 'one' || normIn === 'true')) return true;
      if (normExp === '720' && normIn === '720') return true;
