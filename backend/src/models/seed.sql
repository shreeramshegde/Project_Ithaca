...
INSERT INTO questions (island_id, type, format, question_text, options, correct_answer, reward_years, penalty_years, difficulty_level, sequence_number) VALUES
(4, 'PRE_ROUND', 'MCQ', 'Which god rules the sea?', '["Zeus", "Hades", "Poseidon", "Apollo"]', 'Poseidon', 0, 0, 3, 0);
...
INSERT INTO questions (island_id, type, format, question_text, hint_text, correct_answer, reward_years, penalty_years, difficulty_level, sequence_number) VALUES
(4, 'MAIN', 'NON_MCQ', 'What is the square root of 144?', 'A dozen', '12', 2.0, 0.5, 4, 1),
(4, 'MAIN', 'NON_MCQ', 'Who discovered gravity?', 'Apple fell on his head', 'Isaac Newton', 2.0, 0.5, 4, 2),
(4, 'MAIN', 'NON_MCQ', 'What is the speed of light in vacuum (approx km/s)?', '3 followed by 5 zeros', '300000', 2.0, 0.5, 4, 3);
